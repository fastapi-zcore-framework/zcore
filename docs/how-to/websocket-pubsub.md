...
Pydantic V2 data payload definitions that enforce validation constraints and map database outputs.
...
The service layer acts as the coordinator of business transactions and database operations.
...
### ✂️ 23. Output Projection (`projection & response`)
