<div style="display: flex; flex-direction: column; align-items: center; text-align: center; padding: 4rem 0;">
  ...
  <div style="display: flex; flex-wrap: wrap; gap: 1rem; margin-bottom: 2rem; justify-content: center; align-items: center;">
    ...
    <a href="https://github.com/fastapi-zcore-framework/zcore" style="padding: 0.875rem 2rem; border-radius: 0.375rem; border: 1px solid #27272a; color: #a1a1aa; font-weight: bold; text-decoration: none; transition: all 0.2s; display: flex; gap: 0.25rem;" target="_blank">
